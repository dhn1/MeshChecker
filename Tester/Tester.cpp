...
{
    auto target = Triangle::create (
        Vertex::create (-6.415164999259999945, 5.6080837660800000322, -18), Vertex::create (-6.1588704557899998093, 5.8913302244899998783, -18), Vertex::create (-6.214446746370000163, 5.8357539339200004136, -18), QStringLiteral ("TT70491"), 64);
    auto other = Triangle::create (Vertex::create (-6.2988778737000004071, 6.7076236509099995686, -17.918788480900001758), Vertex::create (-6.214446746370000163, 5.8357539339200004136, -18),
        Vertex::create (-6.0503716433100001026, 5.9998290369799995858, -18), QStringLiteral ("TT45273"), 64);
...
static TestRes useCase05 ()
{
    auto target = Triangle::create (Vertex::create (34.983099559400002931, 2.2009500682800000604, -9.635073482030000136), Vertex::create (35.569933053799999811, 2.2378705023099998428, -9.0798099947900006157),
        Vertex::create (35.640260967499997946, 2.182336575730000151e-15, -9.0798099947900006157), QStringLiteral ("TT12949"), 64);
    auto other = Triangle::create (Vertex::create (35.052267201799999441, 2.1463323415699999308e-15, -9.635073482030000136), Vertex::create (35.640260967499997946, 2.182336575730000151e-15, -9.0798099947900006157),
        Vertex::create (35.569933053799999811, -2.2378705023099998428, -9.0798099947900006157), QStringLiteral ("TT12951"), 64);
...
static TestRes useCase06 ()
{
    auto target = Triangle::create (Vertex::create (18.797366735400000692, 1.1826300734099999268, -15.923727499600000002), Vertex::create (19.825591414200001594, 1.2139673533299999681e-15, -15.620066621799999496),
        Vertex::create (19.786470138300000343, 1.2448591848699999129, -15.620066621799999496), QStringLiteral ("TT36149"), 64);
    auto other = Triangle::create (Vertex::create (18.834532382799999084, 1.1532824897999999192e-15, -15.923727499600000002), Vertex::create (19.786470138300000343, -1.2448591848699999129, -15.620066621799999496),
        Vertex::create (19.825591414200001594, 1.2139673533299999681e-15, -15.620066621799999496), QStringLiteral ("TT36151"), 64);
...
static TestRes useCase07 ()
{
    auto target = Triangle::create (Vertex::create (17.42475366749999921, 0.017424753667500000875, -19.004668948700000897), Vertex::create (17.417528385899998966, 0.24733694153899998813, -19.066273733700001003),
        Vertex::create (17.425301262400001434, 1.0669919707600000829e-15, -18), QStringLiteral ("TT43942"), 1088);
    auto other = Triangle::create (Vertex::create (17.425301262400001434, 1.0669919707600000829e-15, -18), Vertex::create (17.412785682100000884, -0.39825222238099999839, -18), Vertex::create (17.425301262400001434, 4.4088823393800002323e-16, -19),
        QStringLiteral ("TT111919"), 64);
...
{
    auto target = Triangle::create (
        Vertex::create (44.075474737199996866, 79.067209756799996967, 2), Vertex::create (0.9442936788789999536, 15.640481640799999141, 2), Vertex::create (0.633628940779000005, 12.819595897199999257, 2), QStringLiteral ("TT262"), 0);
    auto other = Triangle::create (
        Vertex::create (0.9442936788789999536, 15.640481640799999141, 2), Vertex::create (0.633628940779000005, 12.819595897199999257, 39.5), Vertex::create (0.633628940779000005, 12.819595897199999257, 2), QStringLiteral ("TT159"), 0);
...
{
    auto target = Triangle::create (
        Vertex::create (3.3512096405029296875, 7.8341774940490722656, -18), Vertex::create (3.8266692161560058594, 7.613307952880859375, -18), Vertex::create (3.7787721157073974609, 7.6377129554748535156, -18), QStringLiteral ("TT21370"), 0);
    auto other = Triangle::create (Vertex::create (4.43286895751953125, 8.063358306884765625, -17.918788909912109375), Vertex::create (3.6297621726989746094, 7.7136373519897460938, -18),
        Vertex::create (3.8365087509155273438, 7.6082944869995117188, -18), QStringLiteral ("TT20013"), 0);
...
static TestRes sharedEdge01 ()
{
    ...
    v1->setAnnotation (QStringLiteral ("V1"));
    v2->setAnnotation (QStringLiteral ("V2"));
    v3->setAnnotation (QStringLiteral ("V3"));
    v4->setAnnotation (QStringLiteral ("V4"));

    auto target = Triangle::create (v1, v4, v2);
    target->setEdgeAnnotation (0, QStringLiteral ("E0"));
    target->setEdgeAnnotation (1, QStringLiteral ("E1"));
    target->setEdgeAnnotation (2, QStringLiteral ("E2"));
...
{
    auto t1 = Triangle::create (Vertex::create (19.798989873200000034, 2.1107702762699998011, -19.798989873200000034), Vertex::create (21.288255852300000726, 100, -18.181888150599998966),
        Vertex::create (19.796096761200001168, 100, -19.796096761200001168), QStringLiteral ("t1"), 0);

    auto t2 = Triangle::create (
        Vertex::create (21.213203435600000546, 100, -21.213203435600000546), Vertex::create (18.181888150599998966, 100, -21.288255852300000726), Vertex::create (19.796096761200001168, 100, -19.796096761200001168), QStringLiteral ("t2"), 0);
...
{
    auto t1 = Triangle::create (Vertex::create (5.0643400553599997593, 114.87999999999999545, 0.39857220629700002013), Vertex::create (4, 115, 0), Vertex::create (3.9876693349300000868, 115, 0.31383638291100002249), QStringLiteral (""), 0);

    auto t2 = Triangle::create (Vertex::create (5.0800000000000000711, 114.87999999999999545, 0), Vertex::create (3.9876693349300000868, 115, -0.31383638291100002249), Vertex::create (4, 115, 0), QStringLiteral (""), 0);
...
static TestRes overlapTestCase01 ()
{
    ...
    auto v2 = Vertex::create (99.999999999999943157, 16.602552164169267712, 6.9090201190256115282, QStringLiteral ("v2"));
...
static TestRes overlapTestCase02 ()
{
    auto t1 = Triangle::create (
        Vertex::create (9.7740789473684213107, 100, -19.010605263157913214), Vertex::create (9.2681831578947395656, 100, -19.512842105263178638), Vertex::create (9.393421052631580892, 100, -18.642105263157912276), QStringLiteral ("T1"), 17472);

    auto t2 = Triangle::create (
        Vertex::create (9.3459936842105264532, 95, -19.01263157894738498), Vertex::create (9.393421052631580892, 95, -18.642105263157912276), Vertex::create (9.3697073684210536726, 100, -18.827368421052646852), QStringLiteral ("T2"), 50240);
